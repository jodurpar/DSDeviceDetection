...
export const BROWSERS_RE: any = {
    VIVALDI: /\bVivaldi\b/,
    BRAVE: /\bBrave\b/,
    YANDEX: { or: [/\bYowser\b/, /\bYaBrowser\b/]},
    CHROME: { and: [{ or: [/\bChrome\b/, /\bCriOS\b/] }, { not: { or: [/\bOPR\b/, /\bEdg(e|A|iOS)\b/, /\bSamsungBrowser\b/, /\bUCBrowser\b/, /\bVivaldi\b/, /\bBrave\b/, /\bYowser\b/, /\bYaBrowser\b/] } }] },
    FIREFOX: { or: [/\bFirefox\b/, /\bFxiOS\b/] },
    SAFARI: {
        and: [/^((?!CriOS).)*\Safari\b.*$/, {
            not: {
                or: [/\bOPR\b/, /\bEdg(e|A|iOS)\b/, /\bWindows Phone\b/, /\bSamsungBrowser\b/, /\bUCBrowser\b/, /\bVivaldi\b/, /\bBrave\b/, /\bYowser\b/, /\bYaBrowser\b/]
            }
        }]
    },
...
export const BROWSER_VERSIONS_RE_MAP: any = {
    ...
    VIVALDI: /\bVivaldi\/([\d\.]+)\b/,
    BRAVE: /\bBrave\/([\d\.]+)\b/,
    YANDEX: [/\bYaBrowser\/([\d\.]+)\b/, /\bYowser\/([\d\.]+)\b/],
    SAFARI: /\bVersion\/([\d\.]+)\b/,
